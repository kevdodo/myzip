...
fn main() {
    ...
    // let entries = fs::read_dir(env::current_dir().unwrap()).unwrap();
    ...
    // let file_name = "zip-test.txt";
    // let zip_name = "zippy.zip";

    myzip0(file_name, zip_name);
    let bruh: [u8;1] = [0b1];
